export default function About() {
  return (
    <div className="space-y-12 text-md md:text-lg text-gray-500 pb-4 md:pb-8">
      <p>
        Introducing Filer, the ultimate multimedia conversion powerhouse that
      ...
      <div className="space-y-2">
        ...
        <p>
          Access Filer from any device with an internet connection. Whether
      ...
      <div className="space-y-2">
        <h2 className="text-xl md:text-2xl font-medium text-gray-700">
          🌟 It's Free, It's Powerful, It's Filer:
        </h2>
        <p>
